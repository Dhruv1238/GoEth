...
function Activity() {
    ...
    const { requestRide, connectWallet, getRideRequest, getAllRequestIds } = useContext(TransactionContext);
                ...
                <div className='flex flex-col p-8 gap-6'>
                    ...
                    <div className='flex flex-col'>
                        <div className='flex flex-row justify-between items-center'>
                            ...
                            <Button className='w-8 h-8 p-2 rounded-full bg-black flex items-center justify-center' onClick={getAllRequestIds}>
