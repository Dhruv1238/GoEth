...
function Activity() {
    ...
    const { requestRide, connectWallet, getRideRequest, getAllRideRequests, isLoading, requestedRides } = useContext(TransactionContext);
    ...
    return (
        <>
            <div className='w-[45vh] h-[100vh] bg-white relative'>
                <div className='flex flex-col p-8 gap-6'>
                    ...
                    <div className='flex flex-col'>
                        <div className='flex flex-row justify-between items-center'>
                            ...
                            <Button className='w-8 h-8 p-2 rounded-full bg-black flex items-center justify-center' onClick={getAllRideRequests}>
                ...
                {isLoading ? <Spinner className="h-12 w-12 text-gray-900/50" /> :
                                ...
                                <div key={index} className="flex flex-row justify-between border b-1 rounded-lg">
                                    <div className='flex flex-row items-start p-4 justify-center  gap-5'>
                                        ...
                                        <div className='flex flex-col'>
                                            ...
                                            <p className='font-extralight text-sm text-gray-400'>From </p>
                                            <p className='font-extralight text-sm text-gray-400'>{ethers.utils.formatEther(ride.startingBid)} ETH</p>
                                            <p className='font-extralight text-sm text-gray-400'>{ethers.utils.formatEther(ride.startingBid) * 268873.65} INR</p>
                                        </div>
                                    </div>
                                </div>
