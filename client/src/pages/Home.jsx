                ...
                <div className='flex flex-col h-full justify-between overflow-hidden p-8  '>
                    ...
                    <div className='flex flex-col mb-24 gap-4 '>
                        <div className="flex flex-row justify-between">
                            ...
                            <div className='bg-black flex items-center justify-center p-4 rounded-lg'>
                        ...
                        <div className='flex flex-col border border-2 border-black p-4 rounded-xl gap-4'>
                            <div className='flex flex-row w-full border border-2 border-black p-2 items-center justify-between rounded-lg'>
