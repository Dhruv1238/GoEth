        ...
        <div className="grid h-full max-w-lg grid-cols-4 mx-auto my-auto items-center font-medium justify-between">
          ...
          <Link to="/rent">
            <button type="button" className="inline-flex flex-col items-center justify-center px-5  group">
              ...
              <span className="text-sm text-gray-900 mt-2  group-hover:text-blue-500">Rentals</span>
            </button>
          </Link>
          <Link to="/activity">
            <button type="button" className="inline-flex flex-col items-center justify-center px-5  group">
              ...
              <span className="text-sm text-gray-900   group-hover:text-blue-500">Activity</span>
            </button>
          </Link>
          <Link to="/profile">
            <button type="button" className="inline-flex flex-col items-center justify-center px-5 group">
              <img className="w-8 h-8 mb-0 rounded-full text-gray-900   group-hover:text-blue-500" src={user.photoURL} alt="" />
              <span className="text-sm text-gray-900   group-hover:text-blue-500">Profile</span>
            </button>
          </Link>
        </div>
      </div>
