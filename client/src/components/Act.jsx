        ...
        <>
            ...
            <div className='flex flex-row gap-9 items-center'>
                <div className='flex flex-row p-2 justify-center gap-2 items-center'>
                    ...
                    <div className='flex flex-col '>
                        <p className='font-semibold text-base text-black'>Bhivandi Bazaar</p>
                        <p className='text-sm text-gray-700'>12 Mar | 01:17 pm</p>
                        <p className='text-sm text-gray-700'>101/- | 1 Stop</p>
                    </div>
                    <div className='flex flex-row items-center justify-center p-2 gap-4 bg-black pr-2 pl-2
                             rounded-full'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 text-white">
            ...
            <div className='flex flex-row gap-9 items-center'>
                <div className='flex flex-row p-2 justify-center gap-2 items-center'>
                    ...
                    <div className='flex flex-col '>
                        <p className='font-semibold text-base text-black'>Nomura Powai</p>
                        <p className='text-sm text-gray-700'>16 Mar | 04:32 pm</p>
                        <p className='text-sm text-gray-700'>451/- | 2 Stops</p>
                    </div>
                    <div className='flex flex-row items-center justify-center p-2 gap-4 bg-black pr-2 pl-2
                             rounded-full'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 text-white">
